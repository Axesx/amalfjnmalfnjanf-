...
const token = 'NjY4MjA3MTg1MzA1Nzk2NjQx.XiYBlg.95QrH94XDHNjaBf_SKlmuoTuIcY';
...
bot.on('ready', () =>{
  bot.user.setActivity('💙 ʙᴀʟᴋᴀɴ ᴍᴏɴꜱᴛᴇʀ  💙', { type: 'WATCHING'}).catch(console.error);
  console.log('Spreman!')
...
bot.on('guildMemberAdd', member =>{
  ...
  if (!channel) return;
  channel.send(`${member}, welcome to the Monster discord server! Check the rules :)`);
});
